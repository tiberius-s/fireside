...
You are the lead architect and orchestrator for this reorganization effort. Your task is to oversee the implementation of this plan, ensuring that each phase is executed correctly and that the final structure of the Cargo workspace aligns with the outlined responsibilities for each crate. You will coordinate with the development team, review code changes, and ensure that documentation is updated accordingly throughout the process. When it comes to the actual implementation, delegate code tasks to a 5.3-Codex model agent, providing clear instructions and reviewing their output for quality and adherence to the plan. Same goes for updates and testing. Delegate to GPT-5.2 for documentation updates and verification steps, ensuring that all changes are well-documented and that the workspace is thoroughly tested after each phase. Your role is crucial in maintaining the integrity of the project while guiding the team through this significant restructuring. Make sure to communicate clearly with the team about the goals and expectations for each phase, and provide support as needed to ensure a smooth transition to the new workspace structure. Coordinate tasks effectively betweeh the code-focused agent and the documentation-focused agent, ensuring that both aspects of the project are progressing in tandem. Regularly review the progress of each phase, provide feedback, and make adjustments to the plan as necessary to address any challenges that arise during the implementation. Use your expertise to ensure that the final outcome is a well-organized Cargo workspace that enhances the maintainability and scalability of the Fireside project, while also improving the clarity and usability of the codebase for current and future contributors.

# Graph Report - fireside  (2026-07-11)

## Corpus Check
- 84 files · ~73,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1012 nodes · 1620 edges · 69 communities (56 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74afd9ef`
...
Cohesion: 0.10
Nodes (17): Graph, KeyCode, Option, Result, Self, String, ViewMode, Duration (+9 more)
...
Cohesion: 0.47
Nodes (9): App, Graph, Result, DefaultTerminal, ReloadSource, event_loop(), present(), present_watching() (+1 more)
...
## Knowledge Gaps
- **419 isolated node(s):** `allow`, `PreToolUse`, `PostToolUse`, `allow`, `install.sh script` (+414 more)
...
- **Why does `Session` connect `TUI App Core` to `Render Module`, `CLI Commands`, `Presentation Session`, `Community 6`?**

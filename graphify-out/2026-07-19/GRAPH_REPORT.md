...
## Corpus Check
- 283 files · ~350,864 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3025 nodes · 4144 edges · 276 communities (232 shown, 44 thin omitted)
...
Cohesion: 0.11
Nodes (17): Acceptance bar (the "foolproof" contract, testable), Architecture, Constitution notes (explicit), Decisions needed before/at `/speckit-specify` (clarify-stage inputs), Editing model (foolproof pillar #2: forms and pickers, never syntax), Explicitly out of scope, Fireside — WYSIWYG Authoring Editor Plan (`fireside edit`, 2026-07-19), First-run / empty state (+9 more)
...
## Knowledge Gaps
- **1547 isolated node(s):** `allow`, `PreToolUse`, `PostToolUse`, `allow`, `install.sh script` (+1542 more)

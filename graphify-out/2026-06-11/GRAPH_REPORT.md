...
## Corpus Check
- 176 files · ~90,350 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1853 nodes · 2875 edges · 160 communities (136 shown, 24 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 187 edges (avg confidence: 0.81)
...
Cohesion: 0.15
Nodes (18): Graphify Usage Rules, Copilot CLI Cheat Sheet, Layout enum (12 variants), Transition enum (8 variants, core), Getting Started Guide (First Fireside Graph), Appendix C — Content Block Reference, ContainerBlock, ContentBlock Union (7 core kinds) (+10 more)
...
Cohesion: 0.13
Nodes (13): Dependencies, Design Philosophy, Error Handling, fireside-engine, Module Map, Testing, Build, Fireside (+5 more)
...
Cohesion: 0.14
Nodes (15): Building, Configuration Files, Dependencies, Design Philosophy, CLI Event Loop, Event Loop Architecture, fireside-cli, Terminal Lifecycle (+7 more)
...
Cohesion: 0.22
Nodes (8): CoreError, Dependencies, Design Philosophy, Error Handling, fireside-core, Module Map, Testing, Wire Format Rules
...
Cohesion: 0.22
Nodes (8): Boundaries, Conformance, Design Principles, Entry points for readers, Scope, Terminology, What Fireside is for, Wire Format Baseline
...
## Knowledge Gaps
- **673 isolated node(s):** `PreToolUse`, `allow`, `install.sh script`, `default`, `MD013` (+668 more)
...
- **Why does `load_graph()` connect `Community 148` to `CLI Commands`, `TUI Test Harness`, `Community 149`, `Community 157`, `Community 158`?**

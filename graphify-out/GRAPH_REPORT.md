...
## Corpus Check
- 320 files · ~455,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3939 nodes · 6430 edges · 312 communities (266 shown, 46 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 71 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1cc78934`
...
7. `apply()` - 39 edges
8. `import()` - 33 edges
9. `render_block()` - 33 edges
10. `Diagnostic` - 30 edges
...
- 1-file cycle: `crates/fireside-cli/src/new.rs -> crates/fireside-cli/src/new.rs`
...
- 1-file cycle: `crates/fireside-tui/src/editor/mod.rs -> crates/fireside-tui/src/editor/mod.rs`
...
- 1-file cycle: `crates/fireside-tui/src/follower.rs -> crates/fireside-tui/src/follower.rs`
- 1-file cycle: `crates/fireside-cli/src/main.rs -> crates/fireside-cli/src/main.rs`
- 1-file cycle: `crates/fireside-cli/src/report.rs -> crates/fireside-cli/src/report.rs`
- 1-file cycle: `crates/fireside-cli/src/resume.rs -> crates/fireside-cli/src/resume.rs`
- 1-file cycle: `crates/fireside-cli/src/session.rs -> crates/fireside-cli/src/session.rs`
...
Cohesion: 0.08
Nodes (44): Command, Duration, Graph, Option, Path, PathBuf, Result, String (+36 more)
...
Cohesion: 0.07
Nodes (26): ContentBlock, Duration, EditableField, Graph, Instant, KeyCode, KeyEvent, MouseEvent (+18 more)
...
Cohesion: 0.16
Nodes (40): App, Frame, Graph, HashSet, Line, Node, Option, Rect (+32 more)
...
Cohesion: 0.27
Nodes (5): Option, Self, Style, Default, Tokens
...
Cohesion: 0.11
Nodes (18): 1. What spec-kit and mattpocock/skills actually are, 2. Audit of the current setup, 3. Proposed design: SpecKit-shaped, natively implemented, 4. Three options, ranked, 5. Recommendation, 6. Two-week implementation roadmap, A. Artifact & spec taxonomy, Assessment (+10 more)
...
Cohesion: 0.25
Nodes (7): defaults, transition, view-mode, description, fireside-version, nodes, title
...
Cohesion: 0.13
Nodes (14): files, .github/skills/speckit-analyze/SKILL.md, .github/skills/speckit-checklist/SKILL.md, .github/skills/speckit-clarify/SKILL.md, .github/skills/speckit-constitution/SKILL.md, .github/skills/speckit-converge/SKILL.md, .github/skills/speckit-implement/SKILL.md, .github/skills/speckit-plan/SKILL.md (+6 more)

### Community 32 - "Docs Site Pages"
Cohesion: 0.18
Nodes (18): 404 Page, Docs Landing Page / Specification Map, Fireside Docs Site (Astro + Starlight), TypeSpec Emitter Config (tspconfig.yaml), Fireside Protocol, TypeSpec Domain Model (source of truth), Data Model Quick Reference, Domain Vocabulary (+10 more)
...
Cohesion: 0.15
Nodes (12): Core Principles, Development Workflow & Quality Gates, Fireside Constitution, Governance, I. Spec Is the Source of Truth (NON-NEGOTIABLE), II. Presenter-First Experience, III. Crate Boundary Discipline, IV. Mandatory Code Idioms (+4 more)
...
Cohesion: 0.12
Nodes (22): Graphify Usage Rules, Copilot CLI Cheat Sheet, Graph (runtime repr), GraphFile (wire repr), Layout enum (12 variants), Transition enum (8 variants, core), Getting Started Guide (First Fireside Graph), Appendix C — Content Block Reference (+14 more)
...
Cohesion: 0.11
Nodes (14): fireside-cli, CoreError, fireside-core, fireside-engine, fireside-tui, iTerm2 Theme Import, Boundaries, Conformance (+6 more)
...
Cohesion: 0.15
Nodes (19): Line, Option, String, Style, Tokens, Vec, bold_fragment_carries_bold_style(), find_closer() (+11 more)
...
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Dual-Screen Presenter View, Project Structure, Source Code (repository root), Summary, Technical Context
...
Cohesion: 0.18
Nodes (30): Duration, Follower, Frame, Option, Rect, SessionStatus, String, Style (+22 more)
...
Cohesion: 0.15
Nodes (12): Assumptions, Edge Cases, Feature Specification: Live Validation While Authoring (`validate --watch`), Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)* (+4 more)

### Community 91 - "Community 91"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Live Validation While Authoring (`validate --watch`), Project Structure, Source Code (repository root), Summary, Technical Context

### Community 92 - "Community 92"
Cohesion: 0.29
Nodes (6): Decision: Ctrl-C exits via default SIGINT, no new dependency, Decision: Own polling loop with `std::thread::sleep`, not `Watcher`'s cadence, Decision: Reuse `fingerprint()`, not the `Watcher` struct or `load()`, Decision: Test the polling step as a pure function, not via a spawned infinite loop, Phase 0 Research: `validate --watch`, Resolved Technical Context
...
Cohesion: 0.40
Nodes (4): Change-detection state, Data Model: `validate --watch`, Existing types reused as-is, New shape: watch-cycle report
...
Cohesion: 0.33
Nodes (5): CLI Contract: `fireside validate --watch`, Invocation, Out of scope for this contract, With `--watch`, Without `--watch` (unchanged contract)
...
Cohesion: 0.07
Nodes (54): Command, PathBuf, Drop, art_image_charset_flag_changes_output_characters(), art_image_converts_a_readable_file(), art_image_default_charset_matches_unflagged_output(), art_image_invert_flag_flips_shading(), art_image_no_normalize_reproduces_prior_behavior() (+46 more)
...
Cohesion: 0.07
Nodes (26): Dependencies & Execution Order, Final Phase: Polish & Cross-Cutting Concerns, Implementation for User Story 1, Implementation for User Story 2, Implementation for User Story 3, Implementation for User Story 4, Implementation Strategy, Incremental Delivery (+18 more)
...
Cohesion: 0.17
Nodes (28): App, DefaultTerminal, Display, Duration, Follower, Formatter, Graph, Option (+20 more)

### Community 123 - "Community 123"
Cohesion: 0.22
Nodes (8): ADR-006: Markdown authoring frontend (`fireside import`), Consequences, Context, Decision, Negative or Trade-offs, Neutral / Follow-up, Positive, Status

### Community 124 - "Community 124"
Cohesion: 0.15
Nodes (12): Assumptions, Edge Cases, Feature Specification: Markdown Authoring Frontend (`fireside import`), Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)* (+4 more)
...
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Markdown Authoring Frontend (`fireside import`), Content Quality, Feature Readiness, Notes, Requirement Completeness
...
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Markdown Authoring Frontend (`fireside import`), Project Structure, Source Code (repository root), Summary, Technical Context

### Community 130 - "Community 130"
Cohesion: 0.22
Nodes (8): 1. Markdown parser and inline-content strategy, 2. Node/section boundaries, 3. Content-block conversion within a section, 4. Frontmatter, 5. Branch declaration syntax and parsing, 6. Node id slugification, 7. Validation before write, Phase 0 Research: Markdown Import

### Community 131 - "Community 131"
Cohesion: 0.25
Nodes (7): `BranchDeclaration` (new, `fireside-cli`, transient), `BranchOptionSource` (new, `fireside-cli`, transient), `Frontmatter` (new, `fireside-cli`), `ImportError` (new, `fireside-cli`), Phase 1 Data Model: Markdown Import, Relationships, `Section` (new, `fireside-cli`, transient)

### Community 132 - "Community 132"
Cohesion: 0.33
Nodes (5): Behavioral guarantees this contract exists to make testable, Contract: `fireside import` CLI verb, Exit behavior, Internal module contract (`crates/fireside-cli/src/import.rs`, new module), Invocation

### Community 133 - "Community 133"
Cohesion: 0.22
Nodes (8): Automated coverage (see `tasks.md` for concrete test files), Prerequisites, Quickstart: Validating Markdown Import, Scenario 1 — Linear talk, no branching (User Story 1, P1), Scenario 2 — Branching (User Story 2, P1), Scenario 3 — Unresolved branch target is rejected (User Story 2), Scenario 4 — Nested list is reported, not silently mangled (User Story 3, P2), Scenario 5 — Edge cases
...
Cohesion: 0.43
Nodes (7): Path, PathBuf, Vec, fixture_corpus_matches_documented_expectations(), fixture_paths(), large_deck_loads_and_validates_within_budget(), protocol_dir()
...
Cohesion: 0.14
Nodes (13): Assumptions, Edge Cases, Feature Specification: Modern TUI Leverage, Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)* (+5 more)

### Community 194 - "Community 194"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Modern TUI Leverage, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 195 - "Community 195"
Cohesion: 0.15
Nodes (12): Complexity Tracking, Complexity Tracking, Constitution Check, Documentation (this feature), Documentation (this feature), Implementation Plan: Modern TUI Leverage, Project Structure, Project Structure (+4 more)

### Community 196 - "Community 196"
Cohesion: 0.29
Nodes (6): 1. Mouse hit-testing without breaking the pure-render invariant, 2. Resume position persistence, 3. Synchronized output, 4. OSC 8 hyperlinks — rendering feasibility (the real open question), Phase 0 Research: Modern TUI Leverage, Summary of dependency/protocol impact

### Community 197 - "Community 197"
Cohesion: 0.40
Nodes (4): Link (inline content), No change to existing entities, Phase 1 Data Model: Modern TUI Leverage, Resume Record
...
Cohesion: 0.40
Nodes (4): Contract: Inline link syntax (engine extension, non-normative), Rendering contract, Syntax, Validation contract
...
Cohesion: 0.20
Nodes (9): 1. Property testing library, 2. Arbitrary `Graph`/`ContentBlock` generation strategy, 3. Session-invariant property test shape, 4. Container nesting depth limit, 5. Watcher robustness for half-saved JSON, 6. Multi-codepoint / emoji / CJK-width rendering coverage, 7. ~1,000-node performance fixture, 8. CI: cargo-deny and MSRV verification (+1 more)

### Community 209 - "Community 209"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: Protocol & Workflow Hardening, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 210 - "Community 210"
Cohesion: 0.33
Nodes (5): Data Model: Protocol & Workflow Hardening, New: nesting depth (validator concept, not a model field), New (test-only): `SessionOp`, Reused: conformance fixture entry (`protocol/fixtures/`, spec 004), Reused: `Graph` (`fireside-core::model`)

### Community 211 - "Community 211"
Cohesion: 0.50
Nodes (3): Contract: `container-nesting-depth-exceeded` validator rule, Diagnostic shape, Spec text

### Community 212 - "Community 212"
Cohesion: 0.50
Nodes (3): `audit.yml` — add `pull_request` trigger, Contract: CI workflow changes, `rust.yml` — no change

### Community 213 - "Community 213"
Cohesion: 0.25
Nodes (7): CI review (FR-012), Quickstart: validating Protocol & Workflow Hardening, US1 — Property tests (serde round-trip + session invariants), US2 — Expanded conformance corpus, US3 — Watcher survives half-saved JSON, US4 — Emoji/CJK render-width correctness, Whole-suite gate (run before calling any story done)

### Community 214 - "Community 214"
Cohesion: 0.09
Nodes (22): Dependencies & Execution Order, Implementation for User Story 1, Implementation for User Story 2, Implementation for User Story 3, Implementation for User Story 4, Implementation Strategy, Incremental Delivery, MVP First (User Story 1 Only) (+14 more)

### Community 215 - "Community 215"
Cohesion: 0.22
Nodes (8): ADR-010: Container nesting depth limit, Consequences, Context, Decision, Negative or Trade-offs, Neutral / Follow-up, Positive, Status
...
Cohesion: 0.20
Nodes (9): Branch points, Fullscreen and speaker notes, Incremental reveal, Moving through a deck, Other keys while presenting, Presenting with two screens, Quick-editing a slide, Resuming after a crash or exit (+1 more)
...
Cohesion: 0.33
Nodes (5): Claiming conformance, Regenerating expectations, Rule catalog, Running the corpus, The corpus
...
Cohesion: 0.17
Nodes (38): KeyCode, KeyModifiers, add_block_via_palette_inserts_a_placeholder_and_opens_its_form(), all_kinds_app(), app(), arrow_keys_scroll_too(), below_minimum_size_shows_the_resize_guard_not_the_studio(), bracket_keys_select_the_adjacent_slide_and_wrap() (+30 more)
...
Cohesion: 0.14
Nodes (13): Assumptions, Edge Cases, Feature Specification: ASCII art content block, Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)* (+5 more)

### Community 232 - "Community 232"
Cohesion: 0.22
Nodes (8): Complexity Tracking, Constitution Check, Documentation (this feature), Implementation Plan: ASCII art content block, Project Structure, Source Code (repository root), Summary, Technical Context

### Community 233 - "Community 233"
Cohesion: 0.22
Nodes (8): ADR-011: ASCII art conversion crates MSRV spike — go on figlet-rs + rascii_art, Consequences, Context, Decision, Negative or Trade-offs, Neutral / Follow-up, Positive, Status

### Community 234 - "Community 234"
Cohesion: 0.29
Nodes (6): 1. Conversion crate choice, 2. Whether a new block *kind* can safely degrade in older engines, 3. Rendering: reuse vs. duplicate the spec-005 centering logic, 4. Width threshold for `ascii-art-too-wide`, 5. CLI subcommand shape, Phase 0 Research: ASCII art content block

### Community 235 - "Community 235"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: ASCII art content block, Content Quality, Feature Readiness, Notes, Requirement Completeness

### Community 239 - "Community 239"
Cohesion: 0.10
Nodes (20): `art.rs` (new sibling module, `new.rs`/`import.rs`/`report.rs` pattern), `ascii_art(art: &str, alt: Option<&str>, width: u16, tokens: &Tokens) -> Vec<Line<'static>>`, `ascii-art-empty`, `ascii-art-too-wide`, `AsciiArtBlock` (new model), CLI additions (`fireside-cli`), `Command::Art` (new subcommand, nested), Constitution amendment (`.specify/memory/constitution.md`) (+12 more)

### Community 240 - "Community 240"
Cohesion: 0.33
Nodes (5): Compatibility, Contract: the `ascii-art` ContentBlock kind, Rendering contract, Validation contract, Wire shape

### Community 241 - "Community 241"
Cohesion: 0.40
Nodes (4): Contract: `fireside art` subcommand, `fireside art image <PATH> [--width N]`, `fireside art text <PHRASE>`, Output guarantees (both verbs)
...
Cohesion: 0.15
Nodes (29): BufRead, Graph, Path, Result, Graph, Option, PathBuf, Result (+21 more)
...
Cohesion: 0.15
Nodes (12): Assumptions, Edge Cases, Feature Specification: Dual-Screen Presenter View, Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)* (+4 more)

### Community 278 - "Community 278"
Cohesion: 0.33
Nodes (5): Specification Quality Checklist: Dual-Screen Presenter View, Content Quality, Feature Readiness, Notes, Requirement Completeness
...
Cohesion: 0.14
Nodes (13): 10. Non-tty guard (FR-010), 1. Start the presenter (User Story 1), 2. Start the follower (User Story 1), 3. Navigate and reveal in the presenter (FR-003, SC-001), 4. Reach a branch point (User Story 1, acceptance scenario 3), 5. Reach the final slide (edge case, FR-013), 6. Kill the presenter (User Story 2, SC-002), 7. Restart the presenter against the same follower (User Story 2) (+5 more)
...
Cohesion: 0.22
Nodes (8): ADR-014: Scope extension — dual-screen presenter view, Consequences, Context, Decision, Negative or Trade-offs, Neutral / Follow-up, Positive, Status

### Community 286 - "Community 286"
Cohesion: 0.22
Nodes (8): ADR-015: Session-state file contract for the dual-screen presenter view, Consequences, Context, Decision, Negative or Trade-offs, Neutral / Follow-up, Positive, Status
...
Cohesion: 0.09
Nodes (26): BlockPath, ContentBlock, Option, Self, String, Vec, block_at(), block_at_recurses_into_containers() (+18 more)
...
Cohesion: 0.06
Nodes (101): A, BlockPath, BranchOption, EditorApp, FormState, Graph, Node, Option (+93 more)

### Community 301 - "Community 301"
Cohesion: 0.07
Nodes (21): BlockKind, BlockPath, Diagnostic, EditableField, FieldSlot, FormState, Instant, KeyEvent (+13 more)

### Community 302 - "Community 302"
Cohesion: 0.14
Nodes (28): draw(), Self, a_press_and_release_with_no_movement_is_a_plain_click(), answer_chip_retargets_an_existing_branch_answer(), branch_app(), click(), click_block_reveal_chip(), click_form_chip() (+20 more)

### Community 303 - "Community 303"
Cohesion: 0.42
Nodes (8): EditorApp, Frame, Line, Rect, Tokens, draw(), render_line(), OutlineLine
...
Cohesion: 0.14
Nodes (20): Diagnostic, Path, Result, String, Error, CoreError, EngineError, TuiError (+12 more)

### Community 306 - "Community 306"
Cohesion: 0.17
Nodes (14): ArtGenerator, DefaultTerminal, Graph, Option, Result, TuiError, editor_event_loop(), find_branch_predecessor() (+6 more)

### Community 307 - "Community 307"
Cohesion: 0.22
Nodes (5): MouseEvent, hover_tracks_the_pointer_without_selecting(), move_to(), Msg, resize_updates_terminal_size_and_clears_hover()
...
Cohesion: 0.64
Nodes (10): draw(), EditorApp, Frame, Rect, Tokens, draw_help(), draw_hint(), draw_size_guard() (+2 more)

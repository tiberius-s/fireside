...
## Corpus Check
- 236 files · ~252,670 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2584 nodes · 3812 edges · 231 communities (194 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2dabf884`
...
6. `screen()` - 37 edges
7. `screen()` - 36 edges
8. `render_block()` - 32 edges
9. `Diagnostic` - 26 edges
10. `render()` - 26 edges
...
- 1-file cycle: `crates/fireside-tui/src/render/overlays.rs -> crates/fireside-tui/src/render/overlays.rs`
...
Cohesion: 0.08
Nodes (55): BufRead, Command, Graph, Option, Path, PathBuf, Result, Self (+47 more)
...
Cohesion: 0.15
Nodes (48): ContainerLayout, ContentBlock, Line, Option, Span, String, Tokens, Vec (+40 more)
...
Cohesion: 0.11
Nodes (53): ContentBlock, Display, Formatter, Graph, HashSet, Node, Option, Result (+45 more)
...
Cohesion: 0.07
Nodes (45): BranchOption, BranchPoint, Graph, HashSet, Node, NodeDefaults, NodeId, Option (+37 more)
...
Cohesion: 0.18
Nodes (21): fixturePaths(), fixturesDir, here, main(), checkContainerNestingDepth(), checkDeadEndBranches(), checkEmptyTraversal(), checkMalformedLinkUrls() (+13 more)
...
Cohesion: 0.25
Nodes (7): Development, Fireside, License, Repository structure, The CLI, Try it, What is Fireside?
...
Cohesion: 0.07
Nodes (47): CoreError, BranchOption, BranchPoint, ContentBlock, Node, NodeDefaults, NodeId, Option (+39 more)

### Community 88 - "Render Module"
Cohesion: 0.07
Nodes (94): Buffer, App, EditableField, Frame, KeyCode, KeyModifiers, Line, Option (+86 more)
...
Cohesion: 0.18
Nodes (18): Command, PathBuf, Drop, bare_invocation_teaches_the_three_verbs(), fireside(), import_compiles_markdown_to_a_default_path_and_the_result_validates(), import_refuses_to_overwrite_an_existing_output(), KillOnDrop (+10 more)
...
Cohesion: 0.11
Nodes (17): invalid/dangling-target.json, invalid/duplicate-branch-keys.json, invalid/duplicate-node-ids.json, invalid/nesting-depth-exceeds-limit.json, invalid/next-branch-point-conflict.json, valid/clean.json, valid/dead-end-branch.json, valid/empty-traversal.json (+9 more)
...
Cohesion: 0.30
Nodes (16): App, Frame, Line, Option, Rect, Tokens, Vec, content_inner() (+8 more)
...
Cohesion: 0.10
Nodes (61): App, KeyCode, KeyModifiers, String, app(), arrows_and_enter_choose_an_option(), ascii_art_code_block_centers_within_the_card_at_80x24(), author_hotkey_jumps_straight_to_target() (+53 more)

### Community 229 - "Community 229"
Cohesion: 0.44
Nodes (8): EditableField, Frame, Line, Rect, Tokens, draw_edit(), draw_help(), edit_line()

### Community 230 - "Community 230"
Cohesion: 0.62
Nodes (6): App, Option, Rect, branch_option_hit(), map_row_hit(), rect_contains()
...
## Knowledge Gaps
- **1253 isolated node(s):** `allow`, `PreToolUse`, `PostToolUse`, `allow`, `install.sh script` (+1248 more)
